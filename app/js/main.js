...
async function init() {
  try {
    ...
    const elements = constructorElements(bestMovie, bestMovies, datasCategory1Filter, datasCategory2Filter, allCategories, datasCategory3Filter);
